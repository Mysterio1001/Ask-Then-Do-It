...
[Download ask-then-do-it-1.0.1.zip](https://github.com/Mysterio1001/Ask-Then-Do-It/releases/download/v1.0.1/ask-then-do-it-1.0.1.zip) and extract it. After installing the complete `ask-then-do-it/` Plugin folder, open a new Codex task and enter:

```text
$ask-then-do-it I want to build...
```

The AI will ask one important question first. It will not move to the next stage until you confirm the requirements. For installation, updates, and all eight Skill entry points, see the [Codex Plugin Guide](docs/guides/codex.en.md).

## 2. Use with Gemini or another AI

[Download ask-then-do-it-generic-1.0.1.zip](https://github.com/Mysterio1001/Ask-Then-Do-It/releases/download/v1.0.1/ask-then-do-it-generic-1.0.1.zip) and extract it. Open `generic-workflow.md`, paste the entire file into a new AI conversation, and then describe what you want to do.
