...
Reviewed inputs: Approved [Claude Code Adapter 1.4.0 Specification](../specs/claude-code-adapter.md), Approved [Ticket Plan](../specs/claude-code-adapter.md), `scripts/validate_claude_host_contract.py`, `tests/claude/` fixture and tests, committed unverified contract ledger, exact Claude Code `2.1.251` provenance/preflight evidence, and the post-correction working-tree changes.
