...
本文件彙整原 Approved Claude 1.4.0 requirement/specification，並採用後續已核准的版本統一及文件整理決策。使用者於 2026-09-11 核准將來源統一升至 1.4.1，包含 Core、三 adapters、runtime、catalogs 與 release config；schema version、最低相依版本和歷史發布版本各自獨立。此次升版不將原 1.4.0 核准或實測紀錄改成 1.4.1 證據，也不改變 Claude 行為要求。
