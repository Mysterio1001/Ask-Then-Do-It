...
本文件彙整現行 Core 1.4.3 的 Full／Lite 與 Ticket 測試選擇契約，供維護者查閱。2026-09-10 的文件整理核准只改變文件組織；2026-09-11 核准統一升至 1.4.1，亦不改變這些產品行為。原始需求、規格及核准紀錄的定位見[來源索引](../evidence/release-history.md#document-sources)。
