...
MODEL_MAPPING_SEMANTIC_SHA256 = (
    "8a7e749db5b5c5a0625995c6fe177dd3f643002a8c87bbe0b5b7daf610ce0f69"
)
...
For every envelope, `plugin` must equal `ask-then-do-it`, `version` must equal `1.4.0-preview.1`, and `entry` must equal `/ask-then-do-it:ask-then-do-it`.
...
For every envelope, `plugin` must equal `ask-then-do-it`, `version` must equal `1.4.0-preview.1`, and `entry` must equal `/ask-then-do-it:ask-then-do-it-5`.
