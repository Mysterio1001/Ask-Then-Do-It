...
MODEL_MAPPING_SEMANTIC_SHA256 = (
    "fdba5a2fb64111a15d35a08bf2ab1a0bf422f443788b19e859fe586410c30592"
)
...
For every envelope, `plugin` must equal `ask-then-do-it`, `version` must equal `1.4.3`, and `entry` must equal `/ask-then-do-it:ask-then-do-it-5`.
